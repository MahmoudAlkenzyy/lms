...
import BasicInfoAddCourses from "../components/BasicInfoAddCourses/BasicInfoAddCourses";
import ContentAddCourses from "../components/CurriculumAddCourses/CurriculumAddCourses";
import CourseLevelAddCourse from "../components/CourseLevelAddCourse/CourseLevelAddCourse";
import CourseCategoryAddCourses from "../components/CourseCategoryAddCourses/CourseCategoryAddCourses";
import InstructorInfo from "../components/InstructorInfo/InstructorInfo";
import CourseTagsInput from "../components/CourseTagsInput/CourseTagsInput";
import RatingCourse from "../components/RatingCourse/RatingCourse";
import CourseDurationInput from "../components/CourseDurationInput/CourseDurationInput";
import CourseCertificateToggle from "../components/CourseCertificateToggle/CourseCertificateToggle";
import ProgramSelector from "../components/ProgramSelector/ProgramSelector";
import CourseCodeInput from "../components/CourseCodeInput/CourseCodeInput";
import CourseLanguages from "../components/CourseLanguages/CourseLanguages";
import { toast } from "react-toastify";
import { createStepConfigs } from "../configs/courseStepsConfig";
