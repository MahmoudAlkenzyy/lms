    ...
    >
      ...
      <div className="flex justify-between">
        ...
        <button
          ...
          className={`w-12 h-6 rounded-full relative transition-colors duration-300 bg-gray-300 
          
           ${isRatingEnabled ? "bg-violet-600" : "bg-gray-300"} ${disabled ? "opacity-50 cursor-not-allowed" : ""}
          `}
        >
          <span
